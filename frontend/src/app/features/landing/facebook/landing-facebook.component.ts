...
<div class="page">
  ...
  <section class="hero">
    <h1>Descargar Videos de Facebook Gratis</h1>
    <p>Pega el enlace y descarga en HD. Sin registro, sin instalar nada.</p>
    <div class="search neo">
      <input type="url" [(ngModel)]="url" placeholder="Pega el enlace de Facebook aquí" class="neo-inset" (keydown.enter)="go()" />
      <button (click)="go()" class="btn">Descargar</button>
    </div>
  </section>
  <section class="features">
    <h2>¿Por qué WSSD para Facebook?</h2>
    <div class="cards">
