...
refresh-cookies:
	...
	rsync -az --exclude='.git' --exclude='.env' --exclude='node_modules' --exclude='frontend/.angular' --exclude='backend/target' --exclude='cookies/*.txt' --exclude='cookies/*.json' -e "ssh -o StrictHostKeyChecking=no" ./ root@45.55.251.17:/opt/wssd/
